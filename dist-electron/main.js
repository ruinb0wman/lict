...
(function(exports$12) {
  ...
  function optimize(expr) {
    ...
    while (i2 < expr.length - 1) {
      if (expr[i2] === plus) {
        const res2 = mergeExprItems(expr[i2 - 1], expr[i2 + 1]);
        if (res2 !== void 0) {
          expr.splice(i2 - 1, 3, res2);
          continue;
        }
        expr[i2++] = "+";
      }
...
function makeMergeEvaluated$1({ mergeNames, mergeToName, mergeValues, resultToName }) {
  return (gen, from, to, toName) => {
    const res2 = to === void 0 ? from : to instanceof codegen_1$13.Name ? (from instanceof codegen_1$13.Name ? mergeNames(gen, from, to) : mergeToName(gen, from, to), to) : from instanceof codegen_1$13.Name ? (mergeToName(gen, to, from), from) : mergeValues(from, to);
    return toName === codegen_1$13.Name && !(res2 instanceof codegen_1$13.Name) ? resultToName(gen, res2) : res2;
  };
}
util$1.mergeEvaluated = {
...
var defaults$5 = {};
Object.defineProperty(defaults$5, "__esModule", { value: true });
...
function useKeyword$1(gen, keyword2, result2) {
  if (result2 === void 0)
    throw new Error(`keyword "${keyword2}" failed to compile`);
  return gen.scopeValue("keyword", typeof result2 == "function" ? { ref: result2 } : { ref: result2, code: (0, codegen_1$Z.stringify)(result2) });
}
...
function iterateKeywords$1(it, group) {
  ...
  if (useDefaults)
    (0, defaults_1$2.assignDefaults)(it, group.type);
  gen.block(() => {
...
function normalizeIPv6$1(host2) {
...
function recomposeAuthority$1(component) {
  ...
  if (component.host !== void 0) {
    ...
    if (!isIPv4$1(host2)) {
      const ipV6res = normalizeIPv6$1(host2);
      if (ipV6res.isIPV6 === true) {
        host2 = `[${ipV6res.escapedHost}]`;
      } else {
        host2 = component.host;
      }
    }
...
(function(exports$12) {
  ...
  function requiredOptions(o) {
    var _a2, _b2, _c2, _d2, _e2, _f2, _g2, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _0;
    const s = o.strict;
    ...
    return {
      ...
      strictNumbers: (_h = (_g2 = o.strictNumbers) !== null && _g2 !== void 0 ? _g2 : s) !== null && _h !== void 0 ? _h : true,
...
const def$$ = {
  ...
  code(cxt) {
    ...
    const invalid = prec ? (0, codegen_1$T._)`Math.abs(Math.round(${res2}) - ${res2}) > 1e-${prec}` : (0, codegen_1$T._)`${res2} !== parseInt(${res2})`;
    cxt.fail$data((0, codegen_1$T._)`(${schemaCode} === 0 || (${res2} = ${data}/${schemaCode}, ${invalid}))`);
  }
};
...
(function(module, exports$12) {
  ...
  module.exports = exports$12 = Ajv2020;
...
function makeMergeEvaluated({ mergeNames, mergeToName, mergeValues, resultToName }) {
  return (gen, from, to, toName) => {
    const res2 = to === void 0 ? from : to instanceof codegen_1$v.Name ? (from instanceof codegen_1$v.Name ? mergeNames(gen, from, to) : mergeToName(gen, from, to), to) : from instanceof codegen_1$v.Name ? (mergeToName(gen, to, from), from) : mergeValues(from, to);
    return toName === codegen_1$v.Name && !(res2 instanceof codegen_1$v.Name) ? resultToName(gen, res2) : res2;
  };
}
util.mergeEvaluated = {
...
const def$p = {
  ...
  code(cxt) {
    ...
    const prec = it.opts.multipleOfPrecision;
    const res2 = gen.let("res");
    const invalid = prec ? (0, codegen_1$j._)`Math.abs(Math.round(${res2}) - ${res2}) > 1e-${prec}` : (0, codegen_1$j._)`${res2} !== parseInt(${res2})`;
    cxt.fail$data((0, codegen_1$j._)`(${schemaCode} === 0 || (${res2} = ${data}/${schemaCode}, ${invalid}))`);
  }
};
...
(function(module, exports$12) {
  ...
  module.exports = exports$12 = formatsPlugin;
  Object.defineProperty(exports$12, "__esModule", { value: true });
...
var dist = {};
var getAudioUrl = {};
var assertInputTypes$1 = {};
Object.defineProperty(assertInputTypes$1, "__esModule", { value: true });
var assertInputTypes = function(text2, lang2, slow2, host2) {
  if (typeof text2 !== "string" || text2.length === 0) {
    throw new TypeError("text should be a string");
  }
  if (typeof lang2 !== "string" || lang2.length === 0) {
    throw new TypeError("lang should be a string");
  }
  if (typeof slow2 !== "boolean") {
    throw new TypeError("slow should be a boolean");
  }
  if (typeof host2 !== "string" || host2.length === 0) {
    throw new TypeError("host should be a string");
  }
};
assertInputTypes$1.default = assertInputTypes;
var splitLongText$1 = {};
Object.defineProperty(splitLongText$1, "__esModule", { value: true });
var SPACE_REGEX = "\\s\\uFEFF\\xA0";
var DEFAULT_PUNCTUATION_REGEX = "!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~";
var splitLongText = function(text2, _a2) {
  var _b2 = _a2 === void 0 ? {} : _a2, _c2 = _b2.maxLength, maxLength = _c2 === void 0 ? 200 : _c2, _d2 = _b2.splitPunct, splitPunct = _d2 === void 0 ? "" : _d2;
  var isSpaceOrPunct = function(s, i2) {
    var regex = new RegExp("[" + SPACE_REGEX + DEFAULT_PUNCTUATION_REGEX + splitPunct + "]");
    return regex.test(s.charAt(i2));
  };
  var lastIndexOfSpaceOrPunct = function(s, left, right) {
    for (var i2 = right; i2 >= left; i2--) {
      if (isSpaceOrPunct(s, i2))
        return i2;
    }
    return -1;
  };
  var result2 = [];
  var addResult = function(text3, start2, end2) {
    result2.push(text3.slice(start2, end2 + 1));
  };
  var start = 0;
  for (; ; ) {
    if (text2.length - start <= maxLength) {
      addResult(text2, start, text2.length - 1);
      break;
    }
    var end = start + maxLength - 1;
    if (isSpaceOrPunct(text2, end) || isSpaceOrPunct(text2, end + 1)) {
      addResult(text2, start, end);
      start = end + 1;
      continue;
    }
    end = lastIndexOfSpaceOrPunct(text2, start, end);
    if (end === -1) {
      var str = text2.slice(start, start + maxLength);
...
(function(exports$12) {
  ...
  Object.defineProperty(exports$12, "__esModule", { value: true });
  exports$12.getAllAudioUrls = exports$12.getAudioUrl = void 0;
  var assertInputTypes_12 = __importDefault2(assertInputTypes$1);
  var splitLongText_12 = __importDefault2(splitLongText$1);
  var url_1 = __importDefault2(require$$2$1);
  var getAudioUrl2 = function(text2, _a2) {
    var _b2 = _a2 === void 0 ? {} : _a2, _c2 = _b2.lang, lang2 = _c2 === void 0 ? "en" : _c2, _d2 = _b2.slow, slow2 = _d2 === void 0 ? false : _d2, _e2 = _b2.host, host2 = _e2 === void 0 ? "https://translate.google.com" : _e2;
    assertInputTypes_12.default(text2, lang2, slow2, host2);
    if (text2.length > 200) {
      throw new RangeError("text length (" + text2.length + ') should be less than 200 characters. Try "getAllAudioUrls(text, [option])" for long text.');
    }
    return host2 + "/translate_tts" + url_1.default.format({
      query: {
        ie: "UTF-8",
        q: text2,
        tl: lang2,
        ...
        client: "tw-ob",
        prev: "input",
        ttsspeed: slow2 ? 0.24 : 1
      }
    });
  };
  exports$12.getAudioUrl = getAudioUrl2;
  var getAllAudioUrls = function(text2, _a2) {
    var _b2 = _a2 === void 0 ? {} : _a2, _c2 = _b2.lang, lang2 = _c2 === void 0 ? "en" : _c2, _d2 = _b2.slow, slow2 = _d2 === void 0 ? false : _d2, _e2 = _b2.host, host2 = _e2 === void 0 ? "https://translate.google.com" : _e2, _f2 = _b2.splitPunct, splitPunct = _f2 === void 0 ? "" : _f2;
    assertInputTypes_12.default(text2, lang2, slow2, host2);
    if (typeof splitPunct !== "string") {
      throw new TypeError("splitPunct should be a string");
    }
    return splitLongText_12.default(text2, { splitPunct }).map(function(shortText) {
      return {
        shortText,
        url: exports$12.getAudioUrl(shortText, { lang: lang2, slow: slow2, host: host2 })
      };
    });
  };
  exports$12.getAllAudioUrls = getAllAudioUrls;
})(getAudioUrl);
var getAudioBase64 = {};
var axios$2 = { exports: {} };
...
var enhanceError$1 = function enhanceError2(error2, config, code2, request2, response) {
...
function requireCreateError() {
  ...
  createError = function createError2(message, config, code2, request2, response) {
    ...
    return enhanceError3(error2, config, code2, request2, response);
  };
  return createError;
}
var settle;
...
function requireBrowser() {
  ...
  (function(module, exports$12) {
    ...
    module.exports = requireCommon()(exports$12);
  ...
  (function(module, exports$12) {
    ...
    function init(debug2) {
      ...
      for (let i2 = 0; i2 < keys.length; i2++) {
        debug2.inspectOpts[keys[i2]] = exports$12.inspectOpts[keys[i2]];
      }
    }
    module.exports = requireCommon()(exports$12);
    const { formatters } = module.exports;
...
function requireDebug() {
  ...
  debug_1 = function() {
    if (!debug2) {
      try {
        debug2 = requireSrc()("follow-redirects");
      } catch (error2) {
      }
...
function requireFollowRedirects() {
  ...
  var url = require$$2$1;
  var URL2 = url.URL;
  var http2 = require$$1$3;
  var https2 = require$$2$2;
  ...
  function wrap(protocols) {
    ...
    Object.keys(protocols).forEach(function(scheme) {
      ...
      var wrappedProtocol = exports$12[scheme] = Object.create(nativeProtocol);
      function request2(input, options, callback) {
        ...
        options = Object.assign({
          maxRedirects: exports$12.maxRedirects,
          maxBodyLength: exports$12.maxBodyLength
        }, input, options);
  ...
  followRedirects.exports = wrap({ http: http2, https: https2 });
...
function requireHttp() {
  ...
  http_1 = function httpAdapter(config) {
    return new Promise(function dispatchHttpRequest(resolvePromise, rejectPromise) {
      var resolve2 = function resolve22(value) {
      ...
      var req = transport.request(options, function handleResponse(res2) {
        if (req.aborted) return;
        var stream = res2;
        var lastRequest = res2.req || req;
        if (res2.statusCode !== 204 && lastRequest.method !== "HEAD" && config.decompress !== false) {
        ...
        if (config.responseType === "stream") {
          ...
          stream.on("error", function handleStreamError(err) {
            if (req.aborted) return;
            reject(enhanceError3(err, config, null, lastRequest));
          });
      ...
      req.on("error", function handleRequestError(err) {
        ...
        reject(enhanceError3(err, config, null, req));
      });
      if (config.timeout) {
        ...
        req.setTimeout(timeout2, function handleRequestTimeout() {
          req.abort();
          reject(createError2(
            "timeout of " + timeout2 + "ms exceeded",
            config,
            config.transitional && config.transitional.clarifyTimeoutError ? "ETIMEDOUT" : "ECONNABORTED",
            req
          ));
...
(function(exports$1) {
  ...
  exports$1.getAllAudioBase64 = exports$1.getAudioBase64 = void 0;
  var assertInputTypes_1 = __importDefault(assertInputTypes$1);
  var axios_1 = __importDefault(axios);
  var splitLongText_1 = __importDefault(splitLongText$1);
  var getAudioBase64 = function(text, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.lang, lang = _c === void 0 ? "en" : _c, _d = _b.slow, slow = _d === void 0 ? false : _d, _e = _b.host, host = _e === void 0 ? "https://translate.google.com" : _e, _f = _b.timeout, timeout = _f === void 0 ? 1e4 : _f;
  ...
  var getAllAudioBase64 = function(text2, _a2) {
    var _b2 = _a2 === void 0 ? {} : _a2, _c2 = _b2.lang, lang2 = _c2 === void 0 ? "en" : _c2, _d2 = _b2.slow, slow2 = _d2 === void 0 ? false : _d2, _e2 = _b2.host, host2 = _e2 === void 0 ? "https://translate.google.com" : _e2, _f2 = _b2.splitPunct, splitPunct = _f2 === void 0 ? "" : _f2, _g2 = _b2.timeout, timeout2 = _g2 === void 0 ? 1e4 : _g2;
    return __awaiter(void 0, void 0, void 0, function() {
      var shortTextList, base64List, result2, i2, shortText, base64;
      return __generator(this, function(_h) {
        switch (_h.label) {
          case 0:
            assertInputTypes_1.default(text2, lang2, slow2, host2);
            if (typeof splitPunct !== "string") {
              throw new TypeError("splitPunct should be a string");
            }
            ...
            shortTextList = splitLongText_1.default(text2, { splitPunct });
            return [4, Promise.all(shortTextList.map(function(shortText2) {
              return exports$1.getAudioBase64(shortText2, { lang: lang2, slow: slow2, host: host2, timeout: timeout2 });
            }))];
          case 1:
            base64List = _h.sent();
            result2 = [];
            for (i2 = 0; i2 < shortTextList.length; i2++) {
              shortText = shortTextList[i2];
              base64 = base64List[i2];
              result2.push({ shortText, base64 });
            }
            return [2, result2];
        }
      });
...
(function(exports$12) {
  Object.defineProperty(exports$12, "__esModule", { value: true });
  exports$12.getAllAudioBase64 = exports$12.getAudioBase64 = exports$12.getAllAudioUrls = exports$12.getAudioUrl = void 0;
  var getAudioUrl_1 = getAudioUrl;
  Object.defineProperty(exports$12, "getAudioUrl", { enumerable: true, get: function() {
    return getAudioUrl_1.getAudioUrl;
  } });
  Object.defineProperty(exports$12, "getAllAudioUrls", { enumerable: true, get: function() {
    return getAudioUrl_1.getAllAudioUrls;
  } });
  var getAudioBase64_1 = getAudioBase64;
  Object.defineProperty(exports$12, "getAudioBase64", { enumerable: true, get: function() {
    return getAudioBase64_1.getAudioBase64;
  } });
  Object.defineProperty(exports$12, "getAllAudioBase64", { enumerable: true, get: function() {
    return getAudioBase64_1.getAllAudioBase64;
  } });
})(dist);
var shellQuote = {};
var quote$1 = function quote2(xs) {
...
var parse = function parse2(s, env2, opts) {
...
var exec = require$$0$3.execSync;
var platform = require$$0$2.platform();
var quote = shellQuote.quote;
var findExec$1 = function() {
...
function Play(opts) {
  ...
  this.play = function(what, options, next2) {
    next2 = next2 || function() {
    };
    next2 = typeof options === "function" ? options : next2;
    options = typeof options === "object" ? options : {};
    options.stdio = "ignore";
    this.player == "mplayer" && this.urlRegex.test(what);
    if (!what) return next2(new Error("No audio file specified"));
    if (!this.player) {
      return next2(new Error("Couldn't find a suitable audio player"));
    }
    ...
    if (!process2) {
      next2(new Error("Unable to spawn process with " + this.player));
      return null;
    }
    process2.on("close", function(err) {
      next2(err && !err.killed ? err : null);
    });
    return process2;
  };
  this.test = function(next2) {
    this.play("./assets/test.mp3", next2);
  };
}
var playSound = function(opts) {
  return new Play(opts);
};
const playSound$1 = /* @__PURE__ */ getDefaultExportFromCjs(playSound);
const player = playSound$1({});
...
function createWindow() {
  ...
  let x;
  let y;
  if (savedX !== void 0 && savedY !== void 0) {
    x = savedX;
    y = savedY;
  } else {
...
function createTray() {
  const iconPath = VITE_DEV_SERVER_URL ? path.join(process.env.VITE_PUBLIC, "icon.png") : path.join(RENDERER_DIST, "book-a.png");
...
ipcMain$1.handle("settings:set", (_, settings) => {
...
ipcMain$1.handle("speech:speak", async (_, word) => {
  try {
    console.log("[Main] 播放单词:", word);
    const audioUrl = dist.getAudioUrl(word, {
      lang: "en",
      slow: false,
    ...
    console.error("[Main] 语音播放异常:", error2);
    throw error2;
  }
});
ipcMain$1.handle("favorites:export", async (_, favorites) => {
  try {
    ...
    console.error("Export favorites failed:", error2);
...
ipcMain$1.handle("favorites:import", async () => {
  try {
    ...
    const validFavorites = importData.favorites.filter((f) => {
    ...
    console.error("Import favorites failed:", error2);
    return { success: false, error: String(error2) };
  }
});
...
function sendClipboardContent() {
  if (!win) return;
  const text2 = clipboard.readText().trim();
  if (!text2) return;
  if (!isEnglishText(text2)) return;
  if (!isWord(text2)) return;
  if (text2 === lastClipboardText) return;
  lastClipboardText = text2;
  win.webContents.send("clipboard:content", text2);
}
