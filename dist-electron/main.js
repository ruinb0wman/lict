...
ipcMain$1.handle("settings:export", async (e, r) => {
  try {
    ...
    return console.error("Export settings failed:", n), { success: !1, error: String(n) };
  }
});
ipcMain$1.handle("settings:import", async () => {
  try {
    ...
    if (!n.settings || typeof n.settings != "object")
      return { success: !1, error: "Invalid file format: settings object not found" };
    const s = ["apiBaseUrl", "apiKey", "model", "temperature", "historyLimit"], o = n.settings, a = s.filter((c) => !(c in o));
    return a.length > 0 ? { success: !1, error: `Missing required fields: ${a.join(", ")}` } : {
      success: !0,
      settings: o
    };
  } catch (e) {
    return console.error("Import settings failed:", e), { success: !1, error: String(e) };
  }
});
